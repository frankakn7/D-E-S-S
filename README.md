...
2. Configure the variable called `baseUrl` to equal the Server/Backend URL (where the backend jar will be running. On local machine it should be the default value `https://localhost:8080`)
