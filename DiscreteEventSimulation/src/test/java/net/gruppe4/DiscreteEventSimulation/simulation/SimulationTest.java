...
class SimulationTest {
    ...
    void simpleIsDoableTest() {
        ...
        Operation op1 = new Operation("op1", null, null, 0, 10, mA);
        ArrayList<Operation> condPred = new ArrayList<Operation>();
        condPred.add(op1);
        Operation op2 = new Operation("op2", null, condPred, 0, 10, mB);
        Operation op3 = new Operation("op3", op2, null, 0, 10, mB);
        Operation op4 = new Operation("op4", null, null, 0, 7, mC);
